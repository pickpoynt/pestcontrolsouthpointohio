...
import { Phone, Menu, X, ShieldCheck, Home } from "lucide-react";
...
const Header = () => {
  ...
  const navLinks = [
    { name: "Siding Care", href: "#services" },
    { name: "Mold Info", href: "#siding-mold-info" },
    { name: "FAQ", href: "#faq" },
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 group cursor-pointer">
            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-300 ${isScrolled ? "bg-emerald-600 rotate-0" : "bg-white/10 backdrop-blur-md border border-white/20 rotate-[-10deg] group-hover:rotate-0"}`}>
              <Home className={`w-7 h-7 ${isScrolled ? "text-white" : "text-emerald-500"}`} />
            </div>
            <div>
              ...
              <span className={`text-sm font-bold uppercase tracking-[0.2em] ${isScrolled ? "text-emerald-600" : "text-emerald-400"}`}>
                Exterior <span className="text-[10px] opacity-70">Mold Pros</span>
              </span>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className={`flex flex-col items-end ${isScrolled ? "text-slate-900" : "text-white"}`}>
              <span className="text-[10px] font-bold uppercase tracking-widest opacity-60">Ambler Exterior Line</span>
        ...
        <div className="lg:hidden bg-slate-900 text-white p-6 absolute top-full left-0 right-0 border-t border-slate-800 animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="flex flex-col gap-6">
            ...
            <div className="pt-6 border-t border-slate-800">
              <p className="text-slate-400 text-sm mb-2 uppercase tracking-widest font-bold">Ambler Exterior Line</p>
